            ...
            <ul class="nav" id="side-menu">
               ...
               <li class="active"><a href="#"><i class="fa fa-male fa-fw"></i>Employee<span class="fa arrow"></span></a>
                 <ul class="nav nav-second-level">
                         ...
                         ?>
                  <li class="active"><a href="viewsigninout.php" >View Attendance</a>
                    <ul class="nav nav-second-level">
                     <li>
                        <div class="col-lg-12 "> 
                ...
                echo'<li><div class="col-lg-12 filter_top"> 
                    ...
                    <div class="col-sm-12 filter_bottom hidden" id="li_filter_by_shift">
                      <select class="form-control input-sm myselect" id="filter_by_shift" style="width:100%;">
                      ...
                      <select class = "form-control input-sm myselect" id="filter_by_team" style="width:100%;">
                    ...
                    <div class="col-sm-12 filter_bottom hidden" id="li_filter_by_choice_team">
                      <select class = "form-control input-sm myselect" id="filter_by_choice_team" style="width:100%;" onchange="filtration_checkin();">
                      </select>
                    </div></li>';
                }
              ?>
