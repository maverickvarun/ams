...
<div id="page-wrapper">
<div class="row">
      <div class="col-lg-4"> <h2 >Machine Connection</h2></div>
 </div>
<!-- /.row -->
<div class="row" >
      <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <label>IP Address</label>
                        <input class="form-control" placeholder="enter ip address of machine" id="change_shift_employee" name="change_shift_employee">
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                    <label>Port Number</label>
                        <input class="form-control" placeholder="enter Port Number address of machine" id="change_shift_employee" name="change_shift_employee">
                  </div>
                </div>.
                <div class="col-lg-offset-4">
                <div class="form-group">
                    <button type="button"name="connect" id="connect"  class="btn btn-outline btn-primary btn-lg btn-success">Get Update</button>
