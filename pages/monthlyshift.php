...
<div class="panel panel-default table-responsive">
    <table width="100%" class="table table-striped table-bordered table-hover common-table" id="tablemonthlyshift">
    <thead><tbody>
    <?php 
      $_SESSION['pdf']='';
      $_SESSION['pdf'].= '<tr><td>DATE</td><td>DAYS OF WEEK</td><td>'.$firstname.' '.$lastname.'</td></tr>';
      include('connection.php');
      $query = mysqli_query($con,"select date,day_of_week,$user from monthly_shift_table ");
      if($query) {
